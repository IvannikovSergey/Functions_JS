...
t1.call(document.querySelector('.out-1')); // тут прописываете запуск
...
max.call(document.querySelector('.out-3'), 5, 8); // тут прописываете запуск
...
function t5() {
    return (this.textContent !== undefined) ? true : false; // тут ваш код
}
...
t1.apply(document.querySelector('.out-6')); // тут прописываете запуск
...
max.apply(document.querySelector('.b-7'), [5, 8]); //дописываете здесь
